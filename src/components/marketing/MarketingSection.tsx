  ...
  return (
    <section className={styles.marketing}>
      ...
      <div className={styles.cardContainer}>
        ...
        <div className={styles.polygon} data-aos="fade-up" data-aos-delay="500">
        ...
        <div className={styles.highlightCard} data-aos="fade-up" data-aos-delay="600">
          <h3>매출 전략 강화</h3>
          <p>
        ...
        <div className={styles.imageContainer} data-aos="fade-up" data-aos-delay="800">
          <Image
